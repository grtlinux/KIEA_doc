public class PositiveOperatorMain {
	...
	public static double absol(double doubAbs){
		return (doubAbs>=0.0 ? doubAbs: -doubAbs);
	}
	public static int rectLength(int a1, int b1,
	                             int a2, int b2){
		return (absol(a1-a2)+absol(b1-b2));                             
	}
	public static double distance(int a1, int b1,
								int a2, int b2){
