public class ShitfTests2 {
	...
	public static void main(String[] args) {
		...
		int aaa=-123;
		for(int i=0;i<35;i++){
			System.out.printf("%32s ",Integer.toBinaryString(-123<<i));
			System.out.println(Integer.toBinaryString(-123<<(i%32)));
			//System.out.println(Integer.toBinaryString(-123*(int)Math.pow(2,(i%32))));
			//System.out.println(-123*(int)Math.pow(2,(i%32)));
			//System.out.printf("%32s ",-123<<i);
			//System.out.println(-123*(int)Math.pow(2,(i%32)));
