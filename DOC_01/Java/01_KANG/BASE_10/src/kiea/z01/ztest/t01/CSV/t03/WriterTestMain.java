package kiea.z01.ztest.t01.CSV.t03;
...
public class WriterTestMain
{
	...
	private static void test01(String[] args)
	{
		...
		if (Flag.TRUE) {
			if (args.length != 1) {
				Print.println("USAGE : java WriterTestMain [fileName]");
				System.exit(-1);
			}
		...
		if (Flag.TRUE) {
			...
			for (int i=0; i < 100050; i++) {
				...
				if (Flag.TRUE) bean.setStrRow();
				
				list.add(bean);
			}
			
			if (Flag.TRUE) Print.println("## PART-1 (1) ## took time : %d ms", (System.nanoTime() - time1)/1000/1000);
		}
		...
		if (Flag.TRUE) {
			...
			for (int i=0; i < 100050; i++) {
				...
				if (Flag.TRUE) bean.setBuf();
				
				list.add(bean);
			}
			
			if (Flag.TRUE) Print.println("## PART-1 (2) ## took time : %d ms", (System.nanoTime() - time1)/1000/1000);
		}
		...
		if (Flag.TRUE) {
			...
			if (Flag.TRUE) Print.println("## PART-2 ## took time : %d ms", (System.nanoTime() - time1)/1000/1000);
		}
		...
		if (Flag.TRUE) {
			...
			if (Flag.TRUE) Print.println("## PART-3 ## took time : %d ms", (System.nanoTime() - time1)/1000/1000);
		}
		...
		if (Flag.TRUE) {
			...
			if (Flag.TRUE) Print.println("## PART-4 ## took time : %d ms", (System.nanoTime() - time1)/1000/1000);
		}
		...
		if (Flag.TRUE) {
			...
			try {
				...
				for (int i=0; i < length; i++) {
					 ...
					 * 레코드 처리 "fld1", "fld2" ...
					 */
					if (Flag.TRUE) sb.append(list.get(i).getStrRow());
					if (!Flag.TRUE) sb.append(list.get(i).getBuf());
				}
			...
			if (Flag.TRUE) Print.println("## PART-5 ## took time : %d ms", (System.nanoTime() - time1)/1000/1000);
		}
		...
		if (Flag.TRUE) {
			...
			if (Flag.TRUE) Print.println("## PART-6 ## took time : %d ms", (System.nanoTime() - time1)/1000/1000);
		}
		...
		if (Flag.TRUE) {
			...
			if (Flag.TRUE) Print.println("## PART-7 (1) ## took time : %d ms", (System.nanoTime() - time1)/1000/1000);
			...
			if (Flag.TRUE) Print.println("## PART-7 (2) ## took time : %d ms", (System.nanoTime() - time1)/1000/1000);
		}
	}
	...
	public static void main(String[] args)
	{
		...
		if (Flag.TRUE) test01(new String[] { "D:/KANG.csv" });
	}
}
