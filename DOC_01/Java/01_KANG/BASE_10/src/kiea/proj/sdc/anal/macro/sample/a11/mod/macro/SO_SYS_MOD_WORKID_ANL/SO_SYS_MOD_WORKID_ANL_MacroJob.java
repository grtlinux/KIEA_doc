...
public class SO_SYS_MOD_WORKID_ANL_MacroJob extends AbstractMacroJob
{
	...
	public SO_SYS_MOD_WORKID_ANL_MacroJob(String jobKeyPath, String dsName)
	{
			...
			try {
				...
				if (Flag.TRUE) {
					...
					for (SO_SYS_MOD_WORKID_CP_Bean inBean1 : inList1) {
						...
						outBean1.setBadRate     ("" + (Double.parseDouble(inBean1.getBad()) / Double.parseDouble(inBean1.getTot())));
