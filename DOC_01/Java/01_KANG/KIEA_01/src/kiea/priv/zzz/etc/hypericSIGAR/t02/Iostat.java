...
public class Iostat extends SigarCommandBase
{
	...
	private void outputFileSystem(String arg) throws SigarException
	{
	...
	private void outputDisk(String name) throws SigarException
	{
	...
	private void output(FileSystem fs) throws SigarException
	{
