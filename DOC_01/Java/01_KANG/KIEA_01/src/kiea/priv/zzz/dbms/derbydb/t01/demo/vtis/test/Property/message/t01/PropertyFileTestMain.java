package kiea.priv.zzz.dbms.derbydb.t01.demo.vtis.test.Property.message.t01;
	...
	private static void createTable() throws SQLException
	{
		if (flag) {
			...
			try {
				...
				stmt.execute(""
						+ "create function propertyFileVTI(fileURL varchar(32672)) returns table       \n"
						+ "(                                                                           \n"
	                    ...
	                    + "no sql                                                                      \n"
                        + "external name 'kiea.kr.com.tain.ztest.Derby.t01.demo.vtis.example.PropertyFileVTI.propertyFileVTI'  \n"
						);
			} catch (SQLException e) {
				throw e;
			} finally {
