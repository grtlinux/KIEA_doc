 ...
 */
package kiea.priv.zzz.book.Nutshell.t01.rmi;
import java.rmi.*;
...
import kiea.priv.zzz.book.Nutshell.t01.rmi.Bank.*;  // Import inner classes of Bank
    ...
    public static void main(String[] args) {
        try {
            ...
            System.err.println("Usage: java [-Dbankname=<name>] " +
		        "kiea.priv.zzz.book.Nutshell.t01.rmi.PersistentBankServer " +
			       "[<dbpropsfile>]");
            System.exit(1);
        }
    }
