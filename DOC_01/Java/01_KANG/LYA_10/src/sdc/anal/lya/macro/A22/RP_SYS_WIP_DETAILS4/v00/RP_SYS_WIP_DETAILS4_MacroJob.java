...
public class RP_SYS_WIP_DETAILS4_MacroJob extends AbstractMacroJob
{
	...
	private RP_SYS_WIP_DETAILS4_CsvIo writer1 = null;
	...
	private List<RP_SYS_WIP_DETAILS4_Bean> outList1 = null;
	
	private String filePath = null;

	private String jobId = null;

	public RP_SYS_WIP_DETAILS4_MacroJob(String jobId)
	{
		this.jobId = jobId;
	...
	public void beforeMacroJob()
	{
		...
		if (Flag.TRUE) {
			try {
				...
				writer1 = new RP_SYS_WIP_DETAILS4_CsvIo(this.filePath);
		...
		if (Flag.TRUE) {
			try {
				for (WIP_CELL_RATIO_Bean inBean2 : inList2) {
					...
					RP_SYS_WIP_DETAILS4_Bean outBean1 = new RP_SYS_WIP_DETAILS4_Bean();
