 ...
 */
package kiea.priv.zzz.book.Nutshell.t01.xml;

import java.io.File;
import java.io.IOException;                 // For reading the input file
import java.util.ArrayList;
import java.util.Collections;
import java.util.HashMap;               // Hashtable, lists, and so on
import java.util.Iterator;
import java.util.List;

import javax.xml.parsers.ParserConfigurationException;       // JAXP classes for obtaining a SAX Parser
import javax.xml.parsers.SAXParser;
import javax.xml.parsers.SAXParserFactory;

import org.xml.sax.Attributes;
import org.xml.sax.SAXException;             // The main SAX package
