 ...
 */
package kiea.priv.zzz.book.Nutshell.t01.beans;
import java.beans.*;
import java.awt.*;
...
public class AlignmentEditor extends PropertyEditorSupport {
	...
	Object o = getValue();
	if (o == Alignment.LEFT)
	    return "kiea.priv.zzz.book.Nutshell.t01.beans.Alignment.LEFT";
	if (o == Alignment.CENTER)
	    return "kiea.priv.zzz.book.Nutshell.t01.beans.Alignment.CENTER";
	if (o == Alignment.RIGHT)
	    return "kiea.priv.zzz.book.Nutshell.t01.beans.Alignment.RIGHT";
	return null;
    }
}
